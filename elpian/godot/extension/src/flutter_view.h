 ...
 *     ├─ runs a FIXED, AOT-compiled Flutter "interpreter app" (godot/flutter_host)
 ...
 * `elpian/godot/prelude/flutter.js`, the `FL` facade). It is the twin of the
 ...
 * godot/flutter_host are available — see CMakeLists.txt / SConstruct). Without
